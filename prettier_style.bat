...
call prettier --config ./prettier.config.js --write ./src/utils/GameState.js
call prettier --config ./prettier.config.js --write ./src/utils/quickchats.js
call prettier --config ./prettier.config.js --write ./src/utils/RenderManager.js
call prettier --config ./prettier.config.js --write ./src/utils/SimpleController.js
